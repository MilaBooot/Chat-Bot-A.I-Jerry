/*
    ...
    Description:
		These program is an Jerry like chatterbot,bots like Jerry are the results
		...
		on the chatterbot Jerry that was written by Menilik Eshetu which means
		...
		knowledge is known as "Case Base Reasoning" or CBR. A very good example of an Jerry
	...
	Changes Since Last Submission:
		...
		the user's input. The database (script.txt) has been updated,als can be updated.

	Author:
		Menilik Eshetu

	Website:
		http://facebook.com/spyx meni
		http://www.gmail.com/login/spyxmeni@gmail.com/
*/
